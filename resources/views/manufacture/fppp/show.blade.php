                                    ...
                                    <td class="long">
                                        ...
                                        <form action="{{ route("update-cutting") }}" method="POST">
                                            @csrf
                                                ...
                                                @if (Auth::user()->hasRole("admin-manufacture") || Auth::user()->hasRole("Manager-PPIC") || Auth::user()->hasRole("Admin-PPIC") || Auth::user()->hasRole("Lead-produksi") || Auth::user()->hasRole("Operator-produksi"))
                                                <div class="dropdown">
                                                    <select
