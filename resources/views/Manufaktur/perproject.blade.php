                        ...
                        <div class="col-md-6">
                            <form action="/search-project" method="GET">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Cari berdasarkan no fppp"
                                        name="search">
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach ($mpp as $key => $mPP)
                                        <tr class="text-center">
                                            ...
                                            <td class="sticky-col second-col bg-white width"><a
                                                    href="/monitoring/{{ $mPP['id_fppp'] }}" class="nav-link"><button
                                                        type="button" class="btn btn-info btn-icon"><i
                                                            class="mdi mdi-magnify"></i></button> {{ $mPP['no_fppp'] }}</a>
                                            </td>
