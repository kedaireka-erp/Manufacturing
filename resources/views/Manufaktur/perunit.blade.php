                ...
                <div class="card card-table-header">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <h5 class="card-bredcrumb mb-0"><a href="#" class="text-secondary">Manufaktur / </a><a
                                href="/monitoring" class="text-secondary">Monitoring Per Project / </a><a href="#"
                                class="text-primary">Monitoring Per Unit</a></h5>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <form action="/search-unit/{{ $fppps->id }}" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Cari berdasarkan kode unit"
                                            name="search">
                                        ...
                                        <tr class="text-center">
                                           ...
                                           <td>
                                                @if ($w->tanggal_kaca != null)
                                                    {{ date("d/m/Y", strtotime($w->tanggal_kaca) + 25200)}}
                                                @else
                                                    {{ "-" }}
                                                @endif
                                            </td>
