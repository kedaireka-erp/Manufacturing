$(function () {
    ...
    const itemHoldCount = document.getElementById("itemHoldCount");
    const itemCancelCount = document.getElementById("itemCancelCount");
    const itemRevisiCount = document.getElementById("itemRevisiCount");
    const itemDeliveredCount = document.getElementById("itemDeliveredCount");
    var data = {
    ...
    var doughnutPieData = {
        datasets: [
            {
                data: [
                    parseInt(itemCancelCount.textContent),
                    parseInt(itemHoldCount.textContent),
                    parseInt(itemRevisiCount.textContent),
                    parseInt(itemDeliveredCount.textContent),
                ],
                backgroundColor: [
                    "rgba(255, 99, 132, 0.5)",
                    "rgba(54, 162, 235, 0.5)",
        ...
        labels: ["Cancel", "Hold", "Revisi", "Terkirim"],
    };
